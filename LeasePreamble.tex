...
% Use Linux Libertine <http://www.linuxlibertine.org>, a free and open-source
% font.
...
% titles inline with text. In a standard TeX Live 2016 installation,
% \@startsection is documented in Section 59.2 of
...
\newenvironment{signatureBlock}{%
  \begin{list}{}{%
    ...
    \setlength\leftmargin{\textwidth-\signatureLineLength}%
    \parsep\z@%
    \partopsep\parskip%
  }\item[]%
}{\end{list}}
\newlength\signatureLineLength
\setlength\signatureLineLength{3in}
...
\setlength\signatureLineDepth{\SOUL@uldepth+\SOUL@ulthickness}

\newcommand\signature[1]{%
  \raisebox{0sp}[0sp]{\includegraphics[width=0.5\signatureLineLength]{#1}}%
}
...
\input{support/lease-info.tex}
\input{support/tenant-info.tex}
