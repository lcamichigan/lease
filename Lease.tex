...
shall be paid in installments by the due dates in the first column of
...
rent installments to be paid with certified funds or money orders and in a
single payment.
...
(if any), the first rent installment, security deposit, and any other amounts due the
...
is deemed unpaid rent and shall be due with the next rent installment
after the invoice is sent. Invoices for repairs or
...
new rental rate starts other than on a rent due date, the
amount of increase due from the start date to the rent due date
will be pro-rated and due as part of the next rent
installment.
