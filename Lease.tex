...
\ifbool{isFraternityMember}{%
Landlord may require that any lease
assignment or sublet is to another member of the Chapter.
}{}%
...
%
\ifbool{isFraternityMember}{%
all keys shall be labeled and returned
to the Chapter president or house manager, who
shall return all keys to Landlord when the Premises have been vacated.
}{%
